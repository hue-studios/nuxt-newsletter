<template>
  <div class="flex flex-col h-full bg-white">
    ...
    <div class="flex-shrink-0 border-b border-gray-200 p-4">
      <div class="flex items-center justify-between mb-3">
        ...
        <div class="flex items-center space-x-2">
          ...
          <button
            ...
            class="flex items-center justify-center w-8 h-8 rounded-lg border border-gray-300 bg-white text-gray-500 hover:text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          ...
          <div class="relative">
            <button
              ...
              class="flex items-center justify-center w-8 h-8 rounded-lg border border-gray-300 bg-white text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition-colors"
              title="More actions"
            >
      ...
      <!-- Compilation Status -->
      <div v-if="isCompiling" class="flex items-center space-x-2 text-sm text-blue-600">
        <Icon name="lucide:loader-2" class="w-4 h-4 animate-spin" />
        <span>Compiling newsletter...</span>
      </div>
      
      <div v-else-if="compilationError" class="flex items-center space-x-2 text-sm text-red-600">
        <Icon name="lucide:alert-circle" class="w-4 h-4" />
        <span>Compilation failed</span>
      </div>
      
      <div v-else-if="compiledHtml" class="flex items-center space-x-2 text-sm text-green-600">
    ...
    <div class="flex-1 overflow-hidden bg-gray-100 p-4">
      <!-- Loading State -->
      <div v-if="isCompiling" class="flex items-center justify-center h-full">
      ...
      <!-- Error State -->
      <div v-else-if="compilationError" class="flex items-center justify-center h-full">
      ...
      >
        <div 
          class="bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 border border-gray-200"
          :class="deviceFrameClasses"
        >
          <!-- Device Frame Header (for mobile view) -->
          <div v-if="currentDevice === 'mobile'" class="bg-gray-900 h-6 rounded-t-lg flex items-center justify-center">
      ...
      >
        <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] flex flex-col">
          ...
          <div class="flex items-center justify-between p-6 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">MJML Source</h3>
            <button
          ...
          <div class="flex-1 overflow-auto p-6 bg-gray-50">
            <pre class="text-sm text-gray-800 whitespace-pre-wrap font-mono leading-relaxed">{{ compiledMjml }}</pre>
          </div>
    ...
    >
      <div
        ...
        class="fixed bottom-4 right-4 bg-green-600 text-white px-4 py-2 rounded-lg shadow-lg flex items-center space-x-2"
      >
